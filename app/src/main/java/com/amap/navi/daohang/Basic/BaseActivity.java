...
import com.amap.navi.daohang.util.ErrorInfo;
import com.amap.navi.daohang.util.TTSController;
...
public class BaseActivity extends UnityPlayerNativeActivity implements AMapNaviListener, AMapNaviViewListener {
